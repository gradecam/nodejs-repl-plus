...
_.extend(MongooseReplPlus.prototype, {
    ...
    onStart: function() {
        ...
        self.addCommand('model', self.include.bind(self), 'include a model file');
        self.addCommand('modelD', self.includeDir.bind(self), 'include a directory of models');
        self.addCommand('models', self.refreshModels.bind(self), 'refresh models references');
